...
public class TestLambdas {
	...
	public void test_funcion_2() {
		...
		LongBinaryOperator menor = (long a, long b) -> {
			if(a<b) return a ;
			return b ;
		};
	...
	public void test_extras() {
		...
		BiPredicate<Persona, Persona> sonParientes = (Persona p1, Persona p2) -> p1.getApellido1() == p2.getApellido1();
	...
	public void test_validadores() {
		...
		validador.add(p -> ((Persona) p).getApellido1() != null );
